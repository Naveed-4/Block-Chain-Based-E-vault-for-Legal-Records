...
def main():
    ...
    if not st.session_state.logged_in:
        ...
        st.sidebar.button("Upload Document", on_click=set_page, args=('upload',))
        st.sidebar.button("My Documents", on_click=set_page, args=('documents',))
        st.sidebar.button("Transfer Document", on_click=set_page, args=('transfer',))
        st.sidebar.button("Blockchain Explorer", on_click=set_page, args=('explorer',))
...
def render_transfer_page():
    ...
    try:
        ...
        if st.button("Transfer Document") and selected_document_hash and recipient_username:
            try:
